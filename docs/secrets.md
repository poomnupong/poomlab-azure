...
| `gw1-sea-ssh-host-ed25519-key` | Private SSH host key for gw1-sea (plaz-sea), generated and stored the same way |
| `gw1-krc-ssh-host-ed25519-key` | Private SSH host key for gw1-krc (plaz-krc), generated and stored the same way |
