...
@description('SSH public key for CI/CD deployment access.  Auto-generated by deploy-infra and stored in Azure Key Vault — never a GitHub Actions secret.  When empty the VM is created with the admin key only.')
...
module compute 'modules/compute/main.bicep' = {
  ...
  params: {
    ...
    deploymentSshPublicKey: deploymentSshPublicKey
